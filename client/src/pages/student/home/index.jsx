                ...
                <div className='grid grid-col-2 sm:grid-cols-3 md:grid-cols-4 gap-4'>
                    {
                        courseCategories.map(categoryItem=>
                            <Button className='justify-start' variant='outline' key={categoryItem.id} onClick={()=>handleNavigateToCoursesPage(categoryItem.id)}>{categoryItem.label}</Button>
                        )
                    }
                </div>
            </section> 
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6'>
                    {
                        ...
                        studentViewCoursesList.map(courseItem=> <div onClick={()=>handleCourseNavigate(courseItem?._id)}className='border rounded-lg overflow-hidden shadow cursor-pointer'>
                            <img
