    ...
    return <div className="mx-auto p-4">
        ...
        <DialogContent className="w-[600px]">
            ...
            <div className="flex flex-col gap-2">
                {
                    studentViewCourseDetails?.curriculum?.filter(item=>item.freePreview).map(filteredItem=><p onClick={()=>handleSetFreePreview(filteredItem)} className="cursor-pointer text-[16px] font-medium">{filteredItem?.title}</p>)
                }
            </div>
